<template>
	<view class="container">
		...
		<view class="diygw-col-24 logintitle-clz diygw-text-lg text-purple"> 重置密码 </view>
		...
		<view class="flex flex-wrap diygw-col-24 flex4-clz">
			...
			<view class="flex diygw-col-9 button1-clz">
				<button @tap="navigateTo" data-type="emailCodeApi"
		...
		<view class="flex diygw-col-24 button-clz">
			<button @tap="navigateTo" data-type="resetPasswordApi"
				class="diygw-btn gradual-purple md radius flex-sub margin-xs button-button-clz">点击修改</button>
		</view>
		<view class="flex flex-wrap diygw-col-24 justify-between flex1-clz">
			...
			<view @tap="navigateTo" data-type="page" data-url="/pages/register"
				class="diygw-col-0 text1-clz text-purple"> 注册账户 </view>
		</view>
	...
	export default {
		...
		methods: {
			...
			resetPasswordApi() {
				...
				this.$http.post(
					'http://api.9api.top:9999/user/resetPassword', {
