...
var common_Validate = require("./Validate.js");
var common_Login = require("./Login.js");
var common_Pay = require("./Pay.js");
...
function uploadImage(thiz, field, fieldData, uploadUrl) {
  return new Promise((resolve) => {
    if (!uploadUrl) {
      showToast("\u8BF7\u914D\u7F6E\u4E0A\u4F20\u5730\u5740");
      resolve();
